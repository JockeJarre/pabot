...
--argumenttemplate [FILEPATH]
  ...
  For example:
     ...
     --argumenttemplate template.txt --argumentdata templatedata.csv".
...
### argmenttemplate example:

argumenttemplate.txt

      --variable reportname:${reportname}
      --variable othervalue:${othervalue}
...
pabot call
      ...
      pabot --argumenttemplate argumenttemplate.txt --argumentdata argumentdata.csv argumenttemplate.robot
